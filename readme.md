# Dengue Prediction with Climate Data and Neural Networks

![GitHub License](https://img.shields.io/github/license/yourusername/dengue-prediction)
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/yourusername/dengue-prediction/ci-cd.yml?branch=main)
![MLflow](https://img.shields.io/badge/MLflow-tracking-blue)

A comprehensive system for predicting dengue fever outbreaks using climate data and neural network models.
...
- Monthly dengue incidence rates per 100,000 population
...
- Data from multiple countries spanning several years
